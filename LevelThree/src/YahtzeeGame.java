	...
	*/
	...
	private void markScore()
	{
		...
		while(!b){
			...
			System.out.println(b + "That was an invalid number, please enter again");
			i = s.nextInt();
			b = (i>= 1) && (i<= 13);
		}
		if(i == 1){
			scoreBoard.markOnes(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 2){
			scoreBoard.markTwos(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 3){
			scoreBoard.markThrees(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 4){
			scoreBoard.markFours(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 5){
			scoreBoard.markFives(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 6){
			scoreBoard.markSixes(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 7){
			scoreBoard.markThreeOfAKind(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 8){
			scoreBoard.markFourOfAKind(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 9){
			scoreBoard.markFullHouse(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 10){
			scoreBoard.markSmallStraight(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 11){
			scoreBoard.markLargeStraight(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else if(i == 12) {
			scoreBoard.markYahtzee(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
		else {
			scoreBoard.markChance(dieOne.getValue(), dieTwo.getValue(), dieThree.getValue(), dieFour.getValue(), dieFive.getValue());
			System.out.println(b);
		}
	}
}